angular.module('bhima.controllers')
  .controller('CustomerRegistryController', CustomerRegistryController);

CustomerRegistryController.$inject = [
...
function CustomerRegistryController(
  ...
  {
    field : 'hospital_no',
    displayName : 'INVOICING.CUSTOMER_NUMBER',
    headerCellFilter : 'translate',
  },
  {
  ...
  },
  {
    ...
    name : 'actions',
    displayName : '',
    cellTemplate : '/modules/customer/templates/action.cell.html',
    enableSorting : false,
