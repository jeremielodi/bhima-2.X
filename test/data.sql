...
INSERT INTO `stock_movement` (`uuid`, `lot_uuid`, `document_uuid`, `depot_uuid`, `entity_uuid`, `flux_id`, `date`, `quantity`, `unit_cost`, `is_exit`, `period_id`, `user_id`) VALUES
  (HUID('5b7dd0d6-9273-4955-a703-126fbd504b61'), HUID('ae735e99-8faf-417b-aa63-9b404fca99ac'), HUID('682e11c0-93a7-49f8-b79b-a4bc8e3e6f47'), HUID('f9caeb16-1684-43c5-a6c4-47dbac1df296'), '', 1, DATE_ADD(NOW(), INTERVAL -1376 DAY), 100, 1.2000, 0, DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -1376 DAY), '%Y%m'), 1),
  (HUID('6529ba0c-aef4-4527-b572-5ae77273de62'), HUID('6f80748b-1d94-4247-804e-d4be99e827d2'), HUID('682e11c0-93a7-49f8-b79b-a4bc8e3e6f47'), HUID('f9caeb16-1684-43c5-a6c4-47dbac1df296'), '', 1, DATE_ADD(NOW(), INTERVAL -1376 DAY), 200, 0.8000, 0, DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -1376 DAY), '%Y%m'), 1),
  (HUID('a4ff7358-f1f8-4301-86e4-e9e6fe99bd31'), HUID('5a0e06c2-6ca7-4633-8b17-92e2a59db44c'), HUID('682e11c0-93a7-49f8-b79b-a4bc8e3e6f47'), HUID('f9caeb16-1684-43c5-a6c4-47dbac1df296'), '', 1, DATE_ADD(NOW(), INTERVAL -1376 DAY), 20, 0.5000, 0, DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -1376 DAY), '%Y%m'), 1),
  (HUID('d8c83ad9-a3ea-4f9f-96f9-456a435f480d'), HUID('ef24cf1a-d5b9-4846-b70c-520e601c1ea6'), HUID('682e11c0-93a7-49f8-b79b-a4bc8e3e6f47'), HUID('f9caeb16-1684-43c5-a6c4-47dbac1df296'), '', 1, DATE_ADD(NOW(), INTERVAL -1376 DAY), 50, 2.0000, 0, DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -1376 DAY), '%Y%m'), 1),
  (HUID('f9aa33f1-65e2-4e37-89cb-843d27b2c586'), HUID('064ab1d9-5246-4402-ae8a-958fcdb07b35'), HUID('682e11c0-93a7-49f8-b79b-a4bc8e3e6f47'), HUID('f9caeb16-1684-43c5-a6c4-47dbac1df296'), '', 1, DATE_ADD(NOW(), INTERVAL -1376 DAY), 100, 1.2000, 0, DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -1376 DAY), '%Y%m'), 1),
  (HUID('e8502c3e-7483-11e7-a8de-507b9dd6de91'), HUID('064ab1d9-5246-4402-ae8a-958fcdb07b35'), HUID('0cc6c435-7484-11e7-a8de-507b9dd6de91'), HUID('f9caeb16-1684-43c5-a6c4-47dbac1df296'), HUID('d4bb1452-e4fa-4742-a281-814140246877'), 8, DATE_ADD(NOW(), INTERVAL -1375 DAY), 75, 1.2000, 1, DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -1375 DAY), '%Y%m'), 1),
  (HUID('5c0e5c53-8437-4694-85af-4b3f2135243c'), HUID('aca917fe-5320-4c3c-bea6-590e48cfa26b'), HUID('76d46d03-030f-49ec-80d9-c863aae1a407'), HUID('f9caeb16-1684-43c5-a6c4-47dbac1df296'), '', 1, DATE_ADD(NOW(), INTERVAL -66 DAY), 10, 3.1800, 0, DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -66 DAY), '%Y%m'), 1),
  (HUID('ec78f1ab-e339-41a8-8545-436ebdde358d'), HUID('aca917fe-5320-4c3c-bea6-590e48cfa26b'), HUID('61a151fc-f6e8-41ec-b7a4-f70d6766f8f3'), HUID('f9caeb16-1684-43c5-a6c4-47dbac1df296'), '', 11, DATE_ADD(NOW(), INTERVAL -66 DAY), 10, 3.1800, 1, DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -66 DAY), '%Y%m'), 1);
...
INSERT INTO `stock_movement` (`uuid`, `document_uuid`, `depot_uuid`, `lot_uuid`, `entity_uuid`, `description`, `flux_id`, `date`, `quantity`, `unit_cost`, `is_exit`, `user_id`, `invoice_uuid`, `created_at`, `period_id`) VALUES
  (0xB8E73617428B49FDB256DE9C0DFAB743, 0xECE15AAFA73B4A3C880B828CBEB11FE2, 0xF9CAEB16168443C5A6C447DBAC1DF296, 0x6F80748B1D944247804ED4BE99E827D2, NULL, 'Perte de stock', 11, DATE_ADD(NOW(), INTERVAL -378 DAY), 180, 0.8000, 1, 1, NULL, DATE_ADD(NOW(), INTERVAL -378 DAY), DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -378 DAY), '%Y%m')),
  (0xAD36BEC6350A4E1E8961782468FDAADB, 0xA4F26E8C74F84CD29A908CFDB9352A72, 0xF9CAEB16168443C5A6C447DBAC1DF296, 0xAE735E998FAF417BAA639B404FCA99AC, 0xB1816006555845F993A0C222B5EFA6CB, 'Distribution vers un service', 10, DATE_ADD(NOW(), INTERVAL -378 DAY), 80, 1.2000, 1, 1, NULL, DATE_ADD(NOW(), INTERVAL -378 DAY), DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -378 DAY), '%Y%m')),
  (0x00068A69CBF54B10960234E913B6EE2C, 0xB88D7A6CCA094F0689C03738DC55C3CC, 0xF9CAEB16168443C5A6C447DBAC1DF296, 0x064AB1D952464402AE8A958FCDB07B35, 0x274C51AEEFCC423898C6F402BFB39866, 'Distribution to Test 2 Patient', 9, DATE_ADD(NOW(), INTERVAL -1 WEEK),  10, 1.2000, 1, 1, NULL, DATE_ADD(NOW(), INTERVAL -1 WEEK), DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -1 WEEK), '%Y%m')),
